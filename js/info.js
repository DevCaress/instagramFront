const data = {
    ...
    homeSections: [
        {
            ...
            template: `
                ...
                <div>
                    <input type="tel" name="search" id="search" placeholder="Busca">
                </div>
                ...
                <div>
                    ...
                    <a href="#" id="profile150">
                        <img src="img/profile150.jpg" alt="">
                    </a>
                </div>
    ...
    stories:[
        {img: 'img/profile150.jpg', user: 'caress'},
        {img: 'img/profile150.jpg', user: 'caress'},
        {img: 'img/profile150.jpg', user: 'caress'},
        {img: 'img/profile150.jpg', user: 'caress'},
        {img: 'img/profile150.jpg', user: 'caress'},
    ...
    posts: [
        {
            title:'devcaress',
            imgProfile: 'img/profile150.jpg',
            img:'img/posts/caress.jpg'
        },
        {
            title:'devcaress',
            imgProfile: 'img/profile150.jpg',
    ...
    suggestions: [
        {user: 'devcaress', img: 'img/profile150.jpg'},
        {user: 'devcaress', img: 'img/profile150.jpg'},
        {user: 'devcaress', img: 'img/profile150.jpg'},
        {user: 'devcaress', img: 'img/profile150.jpg'},
        {user: 'devcaress', img: 'img/profile150.jpg'},
